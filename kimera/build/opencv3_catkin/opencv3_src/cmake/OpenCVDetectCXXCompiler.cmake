...
if(ENABLE_CXX11)
  ...
  set(CMAKE_CXX_EXTENSIONS OFF) # use -std=c++14 instead of -std=gnu++11
...
if(NOT HAVE_CXX11)
  ...
  if(NOT HAVE_CXX11 AND ENABLE_CXX11)
    ocv_check_compiler_flag(CXX "-std=c++14" HAVE_STD_CXX11 "${OpenCV_SOURCE_DIR}/cmake/checks/cxx11.cpp")
    if(HAVE_STD_CXX11)
