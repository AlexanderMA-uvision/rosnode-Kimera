...
"""autogenerated by genpy from pose_graph_tools/PoseGraph.msg. Do not edit."""
import codecs
import sys
...
class PoseGraph(genpy.Message):
  _md5sum = "13de81448279ba61bd1e3559bdffd178"
  _type = "pose_graph_tools/PoseGraph"
...
float64[36] covariance"""
  ...
  _slot_types = ['std_msgs/Header','pose_graph_tools/PoseGraphNode[]','pose_graph_tools/PoseGraphEdge[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.edges:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = val1
        buff.write(_get_struct_2Qi().pack(_x.key_from, _x.key_to, _x.type))
        _v8 = val1.pose
        _v9 = _v8.position
        _x = _v9
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (val1.key,) = _get_struct_Q().unpack(str[start:end])
        _v13 = val1.pose
        _v14 = _v13.position
        _x = _v14
        start = end
      ...
      for i in range(0, length):
        ...
        (_x.key_from, _x.key_to, _x.type,) = _get_struct_2Qi().unpack(str[start:end])
        _v18 = val1.pose
        _v19 = _v18.position
        _x = _v19
        start = end
